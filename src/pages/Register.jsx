...
const Register = () => {
    ...
    const renderEventList = (events) => (
        <ul className="list-disc ml-4 md:ml-6 text-gray-300">
    ...
    return (
        <div className="p-4 md:p-8 animate-fadeIn">
            <h2 className="text-2xl md:text-4xl font-bold text-blue-500 mb-6 text-center">Register</h2>
            <div className="flex flex-col lg:flex-row gap-6">
                ...
                <div className="flex-1 basis-3/5 bg-transparent p-4 md:p-6 hover:shadow-xl transition-shadow duration-300 rounded-lg shadow-md">
                    ...
                    <br />
                    <p className="text-sm md:text-lg mb-2 text-gray-300">
                    ...
                    <a
                        ...
                        className="block text-center mt-4 text-lg md:text-xl text-blue-600 hover:underline cursor-pointer"
                    >
